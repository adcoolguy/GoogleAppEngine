...
//import javax.jdo.annotations.PersistenceCapable;	//TBD cause JSP compilation error - something has changed in SDK 1.7.6
...
implements Template, Cloneable, Serializable {
    ...
    public static final String TABLE = "secured";
...
//        append( sb, "lastAccessedDate", lastAccessedDate );
	...
	public String toString() {
		return "Secured [id=" + id + ", platform=" + platform + ", what=" + what
	...
	public Object clone() throws CloneNotSupportedException {
		Secure clone = (Secure)super.clone();
