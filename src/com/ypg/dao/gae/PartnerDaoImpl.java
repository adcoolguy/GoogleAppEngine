...
public class PartnerDaoImpl extends GaeAbstractDaoImpl<Partner> implements PartnerDao {
    ...
    public long insert( Partner dto ) throws DaoException {
...

        {
            ...
            if (dto.getAddedBy() != null) _ent.setProperty( "addedBy", dto.getAddedBy());

            if ( dto.getDate() == null ) {
                dto.setDate( new Date( System.currentTimeMillis()));
            }
            if (dto.getDate() != null) _ent.setProperty( "date", date( dto.getDate() ));

            if ( dto.getFirstName() != null ) {
                checkMaxLength( "firstName", dto.getFirstName(), 500 );
                _ent.setProperty( "firstName", dto.getFirstName());
            }
            if (dto.getFirstName() != null) _ent.setProperty( "firstName", dto.getFirstName());

            if ( dto.getLastName() != null ) {
                checkMaxLength( "lastName", dto.getLastName(), 500 );
                _ent.setProperty( "lastName", dto.getLastName());
            }
            if (dto.getLastName() != null) _ent.setProperty( "lastName", dto.getLastName());
            ...
            if (dto.getPosition() != null) _ent.setProperty( "position", dto.getPosition());
            ...
            if (dto.getNationality() != null) _ent.setProperty( "nationality", dto.getNationality());
            ...
            if (dto.getHomeAddress() != null) _ent.setProperty( "homeAddress", dto.getHomeAddress());

            if ( dto.getState() != null ) {
                checkMaxLength( "state", dto.getState(), 500 );
                _ent.setProperty( "state", dto.getState());
            }
            if (dto.getState() != null) _ent.setProperty( "state", dto.getState());

            if ( dto.getPostalCode() != null ) {
                checkMaxLength( "postalCode", dto.getPostalCode(), 500 );
                _ent.setProperty( "postalCode", dto.getPostalCode());
            }
            if (dto.getPostalCode() != null) _ent.setProperty( "postalCode", dto.getPostalCode());

            if ( dto.getCountry() != null ) {
                checkMaxLength( "country", dto.getCountry(), 500 );
                _ent.setProperty( "country", dto.getCountry());
            }
            if (dto.getCountry() != null) _ent.setProperty( "country", dto.getCountry());
            ...
            if (dto.getHomeNumber() != null) _ent.setProperty( "homeNumber", dto.getHomeNumber());

            if ( dto.getEmail() != null ) {
                checkMaxLength( "email", dto.getEmail(), 500 );
                _ent.setProperty( "email", dto.getEmail());
            }
            if (dto.getEmail() != null) _ent.setProperty( "email", dto.getEmail());

            if ( dto.getPassword() != null ) {
                checkMaxLength( "password", dto.getPassword(), 500 );
                _ent.setProperty( "password", dto.getPassword());
            }
            if (dto.getPassword() != null) _ent.setProperty( "password", dto.getPassword());
    ...
    public boolean update( long id, Partner dto ) throws DaoException {
        ...
        if ( dto.isAddedByModified()) {
            checkMaxLength( "addedBy", dto.getAddedBy(), 500 );
            if (dto.getAddedBy() == null) _ent.removeProperty( "addedBy" );
            else _ent.setProperty( "addedBy", dto.getAddedBy());
            isUpdated = true;
        }

        if ( dto.isDateModified()) {
            if (dto.getDate() == null) _ent.removeProperty( "date" );
            else _ent.setProperty( "date", date( dto.getDate() ));
            isUpdated = true;
        }

        if ( dto.isFirstNameModified()) {
            checkMaxLength( "firstName", dto.getFirstName(), 500 );
            if (dto.getFirstName() == null) _ent.removeProperty( "firstName" );
            else _ent.setProperty( "firstName", dto.getFirstName());
            isUpdated = true;
        }

        if ( dto.isLastNameModified()) {
            checkMaxLength( "lastName", dto.getLastName(), 500 );
            if (dto.getLastName() == null) _ent.removeProperty( "lastName" );
            else _ent.setProperty( "lastName", dto.getLastName());
            isUpdated = true;
        }
        ...
        if ( dto.isPositionModified()) {
            checkMaxLength( "position", dto.getPosition(), 500 );
            if (dto.getPosition() == null) _ent.removeProperty( "position" );
            else _ent.setProperty( "position", dto.getPosition());
            isUpdated = true;
        }

        if ( dto.isIpAddressModified()) {
            checkMaxLength( "ipAddress", dto.getIpAddress(), 100 );
            if (dto.getIpAddress() == null) _ent.removeProperty( "ipAddress" );
            else _ent.setProperty( "ipAddress", dto.getIpAddress());
            isUpdated = true;
        }
        ...
        if ( dto.isNationalityModified()) {
            checkMaxLength( "nationality", dto.getNationality(), 500 );
            if (dto.getNationality() == null) _ent.removeProperty( "nationality" );
            else _ent.setProperty( "nationality", dto.getNationality());
            isUpdated = true;
        }

        if ( dto.isHomeAddressModified()) {
            checkMaxLength( "homeAddress", dto.getHomeAddress(), 500 );
            if (dto.getHomeAddress() == null) _ent.removeProperty( "homeAddress" );
            else _ent.setProperty( "homeAddress", dto.getHomeAddress());
            isUpdated = true;
        }

        if ( dto.isStateModified()) {
            checkMaxLength( "state", dto.getState(), 500 );
            if (dto.getState() == null) _ent.removeProperty( "state" );
            else _ent.setProperty( "state", dto.getState());
            isUpdated = true;
        }

        if ( dto.isPostalCodeModified()) {
            checkMaxLength( "postalCode", dto.getPostalCode(), 500 );
            if (dto.getPostalCode() == null) _ent.removeProperty( "postalCode" );
            else _ent.setProperty( "postalCode", dto.getPostalCode());
            isUpdated = true;
        }

        if ( dto.isCountryModified()) {
            checkMaxLength( "country", dto.getCountry(), 500 );
            if (dto.getCountry() == null) _ent.removeProperty( "country" );
            else _ent.setProperty( "country", dto.getCountry());
            isUpdated = true;
        }
        ...
        if ( dto.isHomeNumberModified()) {
            checkMaxLength( "homeNumber", dto.getHomeNumber(), 500 );
            if (dto.getHomeNumber() == null) _ent.removeProperty( "homeNumber" );
            else _ent.setProperty( "homeNumber", dto.getHomeNumber());
            isUpdated = true;
        }

        if ( dto.isEmailModified()) {
            checkMaxLength( "email", dto.getEmail(), 500 );
            if (dto.getEmail() == null) _ent.removeProperty( "email" );
            else _ent.setProperty( "email", dto.getEmail());
            isUpdated = true;
        }

        if ( dto.isPasswordModified()) {
            checkMaxLength( "password", dto.getPassword(), 500 );
            if (dto.getPassword() == null) _ent.removeProperty( "password" );
            else _ent.setProperty( "password", dto.getPassword());
            isUpdated = true;
        }
